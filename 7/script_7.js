...
// Alternative resolution using two events

// lightBulbImg.addEventListener('mouseenter', function() {
//   lightBulbImg.src = lightOnSource;
// })

// lightBulbImg.addEventListener('mouseleave', function(){
//   lightBulbImg.src = lightOffSource;
// })


lightBulbImg.addEventListener('mouseover', function() {
